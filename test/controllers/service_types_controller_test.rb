...
class ServiceTypesControllerTest < ActionController::TestCase
  ...
  test "should create service_type" do
    assert_difference('ServiceType.count') do
      post :create, service_type: { description: @service_type.description, key: @service_type.key, name: @service_type.name }
    end
  ...
  test "should update service_type" do
    patch :update, id: @service_type, service_type: { description: @service_type.description, key: @service_type.key, name: @service_type.name }
    assert_redirected_to service_type_path(assigns(:service_type))
  end
